...
class FlaskappTests(unittest.TestCase):
    ...
    def test_users_status_code(self):
        ...
        # assert the status code of the respone 
    ...
    def test_updusers_status_code(self):
        ...
        # on the specified path
        result = self.app.put('/api/v1/users/2', data='{"username":"Tagning", "email": "leolaLguertin@teleworm.us"}', content_type='application/json')
        # assert the status code of the response
